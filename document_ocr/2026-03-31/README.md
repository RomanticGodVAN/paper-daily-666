...
- Reason: Central task is analyzing handwritten Chinese characters, a core OCR/document AI area.
...
- Announcement date: 2026-03-31
- Categories: cs.CV
- Tags: table understanding, document understanding, markup, scientific documents
...
## 4. EuraGovExam: A Multilingual Multimodal Benchmark from Real-World Civil Service Exams

- arXiv: `2603.27223`
- Link: https://arxiv.org/abs/2603.27223
- Announcement date: 2026-03-31
- Categories: cs.AI, cs.CV
- Tags: multimodal benchmark, layout-aware, document images, tables, forms
- Reason: Benchmark from real exam documents requiring layout-aware reasoning from visual input.
...
- Reason: Central contribution is Falcon OCR model with explicit OCR evaluation; includes document benchmarks.
...
## 6. Data Organization Matters in Multimodal Instruction Tuning: A Controlled Study of Capability Trade-offs
...
- Reason: Explicitly studies OCR/document understanding capabilities in multimodal models; central to the analysis.
...
## 7. JaWildText: A Benchmark for Vision-Language Models on Japanese Scene Text Understanding

- arXiv: `2603.27942`
- Link: https://arxiv.org/abs/2603.27942
- Announcement date: 2026-03-31
- Categories: cs.AI, cs.CV
- Tags: scene text, benchmark, Japanese, receipt KIE, handwriting OCR, STVQA
- Reason: Central focus is Japanese scene text understanding benchmark with tasks including receipt key information extraction (layout-aware structured extraction) and handwriting OCR, directly targeting OCR and document AI tasks.
...
## 8. Efficient Domain Adaptation for Text Line Recognition via Decoupled Language Models

- arXiv: `2603.28028`
- Link: https://arxiv.org/abs/2603.28028
- Announcement date: 2026-03-31
- Categories: cs.CV, cs.LG
- Tags: OCR, text line recognition, domain adaptation, historical documents, handwriting
- Reason: Central focus is optical character recognition (OCR) for document digitization, specifically efficient domain adaptation for text line recognition across modern/historical documents.
...
## 9. Transcription and Recognition of Italian Parliamentary Speeches Using Vision-Language Models

- arXiv: `2603.28103`
- Link: https://arxiv.org/abs/2603.28103
- Announcement date: 2026-03-31
- Categories: cs.AI, cs.DL, cs.IR
- Tags: OCR, parliamentary speeches, transcription, layout analysis, reading order, semantic segmentation
- Reason: Central focus is OCR pipeline for transcribing scanned historical parliamentary documents with layout preservation, reading order, and semantic annotation, directly targeting document parsing.
...
## 10. Quid est VERITAS? A Modular Framework for Archival Document Analysis

- arXiv: `2603.28108`
- Link: https://arxiv.org/abs/2603.28108
- Announcement date: 2026-03-31
- Categories: cs.AI, cs.DL, cs.IR
- Tags: OCR, layout analysis, historical documents, digitization, transcription, semantic enrichment
- Reason: Central focus is modular framework for archival document analysis encompassing OCR transcription, layout analysis, and semantic enrichment of historical documents.
...
## 11. MDPBench: A Benchmark for Multilingual Document Parsing in Real-World Scenarios

- arXiv: `2603.28130`
- Link: https://arxiv.org/abs/2603.28130
- Announcement date: 2026-03-31
- Categories: cs.AI, cs.CV
- Tags: document parsing, benchmark, multilingual, OCR, document image
- Reason: Central focus is benchmark for multilingual document parsing of digital and photographed documents, directly targeting document AI/OCR evaluation.
...
## 12. MarkushGrapher-2: End-to-end Multimodal Recognition of Chemical Structures

- arXiv: `2603.28550`
- Link: https://arxiv.org/abs/2603.28550
- Announcement date: 2026-03-31
- Categories: cs.CV
- Tags: OCR, document understanding, chemical structure recognition, multimodal document parsing
- Reason: Central task is multimodal recognition of chemical structures from documents using dedicated OCR model and layout analysis, explicitly targeting document parsing and structured content extraction.
...
## 13. Navigating the Mirage: A Dual-Path Agentic Framework for Robust Misleading Chart Question Answering

- arXiv: `2603.28583`
- Link: https://arxiv.org/abs/2603.28583
- Announcement date: 2026-03-31
- Categories: cs.AI, cs.CV, cs.MM
- Tags: OCR, chart understanding, document VQA, agentic framework
- Reason: Core contribution includes OCR-driven data path for chart question answering, targeting document-like chart parsing and structured content extraction from deceptive visual documents.
